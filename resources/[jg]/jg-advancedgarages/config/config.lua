...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ["VB Tuner Shop"] = { -- If you change the name of this garage from Legion Square, you must change the default value of `garage_id` to the same name in the SQL table `players_vehicles`
    coords = vector3(-1619.455933, -853.754456, 10.041639),
    spawn = {vector4(-1619.455933, -853.754456, 10.041639, 139.969864), vector4(-1621.590454, -851.513855, 10.053695, 141.516342), vector4(-1624.084106, -849.562195, 10.036424, 142.725266), vector4(-1626.437500, -847.445374, 10.038341, 137.808914), vector4(-1628.496338, -845.584534, 10.046589, 149.292572), vector4(-1630.949463, -843.489807, 10.034233, 145.089417)}, --  you can add multiple spawn locations into a table
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {

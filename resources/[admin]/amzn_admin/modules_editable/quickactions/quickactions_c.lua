...
local QuickActions = {
    ...
    ["quickaction:ReviveSelf"] = function()
        Bridge.ReviveSelf()
        TriggerServerEvent('amzn_admin:server:logQuickAction', "ReviveSelf", "Revived self")
    ...
    ["quickaction:ToggleInvisibility"] = {
        ...
        func = function(state)
            ...
            return not state, not state and "Invisibility enabled." or "Invisibility disabled."
        end
    },

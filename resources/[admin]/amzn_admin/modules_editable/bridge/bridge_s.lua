...
local imageTemplateByInventory = {
    ...
    codem = 'nui://codem-inventory/html/images/%s.png',
...
local imageTemplateByInventoryHasImageData = {
    ...
    codem = 'nui://codem-inventory/html/images/%s',
...
function Bridge.SetTime(hours, minutes)
    ...
    local strategies = {
        ...
        { function() return isStarted('Renewed-Weathersync') end, function() GlobalState.currentTime = { hour = h, minute = m } return true end },
    }
    if not firstTrue(strategies) then

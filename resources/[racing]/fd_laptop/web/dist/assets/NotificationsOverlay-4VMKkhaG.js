import{B as P,c as m,o as i,a as n,m as c,R as G,j as N,k as y,v as k,l as H,F as x,u as b,b7 as D,p as L,b8 as U,r as F,n as C,w as A,z as j,b9 as X,ba as Y,bb as h,H as R,C as q,a3 as W,G as J,a4 as K,aY as Q,i as ee,L as M,M as d,a2 as v,aW as _,bc as te}from"./index-D8HCwQPV.js";import{s as V}from"./index-DYfg_i5Y.js";import{s as I}from"./index-CG8GTDOY.js";import{s as oe}from"./index-Ck-syyjV.js";import{s as w}from"./index-Bfx_E94B.js";function se(e){return typeof HTMLElement=="object"?e instanceof HTMLElement:e&&typeof e=="object"&&e!==null&&e.nodeType===1&&typeof e.nodeName=="string"}function ae(e,o="",t){se(e)&&t!==null&&t!==void 0&&e.setAttribute(o,t)}function ne(e){return e==null||e===""||Array.isArray(e)&&e.length===0||!(e instanceof Date)&&typeof e=="object"&&Object.keys(e).length===0}function re(){let e=[];const o=(s,l,p=999)=>{const $=r(s,l,p),g=$.value+($.key===s?0:p)+1;return e.push({key:s,value:g}),g},t=s=>{e=e.filter(l=>l.value!==s)},u=(s,l)=>r(s).value,r=(s,l,p=0)=>[...e].reverse().find($=>!0)||{key:s,value:p},a=s=>s&&parseInt(s.style.zIndex,10)||0;return{get:a,set:(s,l,p)=>{l&&(l.style.zIndex=String(o(s,!0,p)))},clear:s=>{s&&(t(a(s)),s.style.zIndex="")},getCurrent:s=>u(s)}}var S=re();const ie=({dt:e})=>`
.p-toast {
    width: ${e("toast.width")};
